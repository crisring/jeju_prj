...
public class AccommodationController {
	...
	public String accList(HttpSession session, SearchAccVO sVO, @RequestParam(defaultValue = "1") int page,
			Model model) {
	...
	public String updateAccommodation(@RequestParam(value = "fcl_names", required = false) List<String> fcl_names,
			...
			@RequestParam(value = "content", required = false) List<String> contents, AccommodationDomain acc,
			Model model) {
