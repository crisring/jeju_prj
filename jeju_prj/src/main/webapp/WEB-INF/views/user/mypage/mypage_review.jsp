                ...
                <c:forEach var="review" items="${myReviewList}" varStatus="i">
                    <tr>
                        ...
                        <td>
                            ...
                            <c:forEach var="j" begin="${review.rating+1}" end="5">
                                ☆
                            </c:forEach>
                        </td>
                            ...
                            <div class="btn-group">
                                ...
                                <!-- [삭제] : POST 방식 -->
                                <form action="/mypage/removeReviewProcess" method="post" style="display:inline;"
...
<div class="modal fade" id="reviewModal" tabindex="-1" aria-labelledby="reviewModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- 수정 처리 action -->
            <form id="frmReviewUpdate" method="post" action="/mypage/modifyReviewProcess" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label>숙소명</label>
                        <input type="text" id="modal_acm_name" class="form-control" name="acm_name" readonly>
                    </div>
				...
				<div>  
                    ...
                    <div class="mb-3">
                        <label>내용</label>
                        <textarea class="form-control" name="content" id="modal_content" rows="5"></textarea>
                    </div>

                    <!-- 기존 이미지 미리보기 -->
                    <div class="mb-3" id="oldImgWrap">
                        <img id="modal_old_img" alt="리뷰 이미지" style="max-width:150px; max-height:150px; display:none;">
                    </div>
...
$(document).ready(function(){
    ...
    $(".btn-open-modal").on("click", function(){
        ...
        // 기존 이미지 미리보기
        if(img){
            $("#modal_old_img").attr("src", img).show();
        } else {
            $("#modal_old_img").hide();
        }
    });
