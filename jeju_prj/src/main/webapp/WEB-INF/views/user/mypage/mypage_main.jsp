...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (birthValue && birthValue.length === 8) {
        var formattedBirth = birthValue.substring(0,4) + '-' + birthValue.substring(4,6) + '-' + birthValue.substring(6,8);
...
<div id="wrap">
    ...
    <div id="main">
        ...
        <!-- 임시로 생년월일 값 확인 (디버깅 후 제거) -->
        <p>생년월일: ${user_info.birth}</p>
        ...
        <form action="/mypage/modifyinfoProcess" method="post"
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control w-75" id="id"
                           name="user_id"
                           value="${user_info.user_id}" readonly>
                </div>
                <div class="col-md-6">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control w-75" id="tel"
                           name="phone_number"
                           value="${user_info.phone_number}">
                </div>
                <div class="col-md-6">
                    <label for="birthdate" class="form-label">생년월일</label>
                    <input type="date" class="form-control w-75" id="birthdate"
                           name="birth"
        ...
        <div>
            <p>
                이용을 원하지 않으신가요?
                <a href="/mypage/withdrawFrm">회원탈퇴</a>
                <span style="text-align: right;">
                    비밀번호 <a href="/mypage/reset_pass">변경하기</a>
                </span>
            </p>
        </div>
