			...
			<form id="memberFrm" name="memberFrm" method="post"
				...
				<div class="mb-3">
					...
					<div class="d-flex align-items-center gap-2">
						<input type="text" class="form-control" id="user_id"
							name="user_id" placeholder="아이디를 입력하세요"> <input
							type="hidden" name="idDupFlag" id="idDupFlag" />

						<button class="btn btn-light" type="button"
							style="white-space: nowrap; padding: 5px 10px;" onclick="idDup()">
							ID 중복체크</button>
					</div>
				...
				<div class="mb-3">
					<label for="password" class="form-label">비밀번호</label> <input
						...
						placeholder="비밀번호 (8자 이상)"> <small class="text-muted">8자
						이상 입력하세요.</small>
				...
				<div class="mb-3">
					<label for="confirm-password" class="form-label">비밀번호 확인</label> <input
						...
						name="confirm-password" placeholder="비밀번호 확인">
				...
				<div class="mb-3">
					...
					<div>
						...
						<div class="form-check">
							<input class="form-check-input" type="radio" name="gender"
								id="female" value="W"> <label class="form-check-label"
								for="female">여자</label>
						</div>
					</div>
				...
				<div class="mb-3">
					<label for="phone_number" class="form-label">전화번호</label> <input
						...
						name="phone_number" placeholder="예: 010-1234-5678"> <small
						class="text-muted">형식: 010-1234-5678</small>
