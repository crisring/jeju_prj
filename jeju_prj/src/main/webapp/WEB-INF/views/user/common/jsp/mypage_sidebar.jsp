...
<!-- sidebar 관련 HTML -->
<div id="sidebar" class="btn-group-vertical" role="group" aria-label="Vertical button group">
  <a href="#" class="btn btn-outline-secondary" onclick="setActive(this)">예약내역</a>
  <a href="#" class="btn btn-outline-secondary" onclick="setActive(this)">내정보관리</a>
